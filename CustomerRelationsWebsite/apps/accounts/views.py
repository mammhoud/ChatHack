...
from apps.accounts.forms import SigninForm, SignupForm, UserPasswordChangeForm, UserSetPasswordForm, UserPasswordResetForm, \
    ProfileForm
...
from apps.accounts.utils import user_filter
...
def user_list(request):
    ...
    return render(request, 'apps/accounts.html', context)
