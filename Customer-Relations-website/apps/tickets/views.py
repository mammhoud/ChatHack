...
class TicketListView(LoginRequiredMixin, generic.ListView):
    model = Ticket
    template_name = 'apps/tickets/index.html'
...
class TicketDetailView(LoginRequiredMixin, generic.DetailView):
    model = Ticket
    login_url = '/accounts/signin/'
    template_name = 'apps/tickets/ticket_detail.html'
...
class TicketCreateView(LoginRequiredMixin, generic.CreateView):
    ...
    login_url = '/accounts/signin/'
    template_name = 'apps/tickets/ticket_form.html'

    # template_name_suffix = 'apps/tickets/'
...
class TicketUpdateView(LoginRequiredMixin, generic.UpdateView):
    ...
    template_name = 'apps/tickets/ticket_update.html'
    login_url = '/accounts/signin/'


class TicketDeleteView(LoginRequiredMixin, generic.DeleteView):
    model = Ticket
    template_name = 'apps/tickets/ticket_confirm_delete.html'
...
def ticket_list(request):
    ...
    return render(request, 'apps/tickets/allissues.html', {'tickets': tickets})
...
def urgent_ticket_list(request):
    ...
    return render(request, 'apps/tickets/urgent.html', {'tickets': tickets})
...
def resolved_tickets(request):
    ...
    return render(request, 'apps/tickets/closed.html', {'tickets': tickets})
...
def unresolved_tickets(request):
    ...
    return render(request, 'apps/tickets/open.html', {'tickets': tickets})
...
def mark_ticket_as_resolved(request, id):
    ...
    return HttpResponseRedirect(reverse("tickets:ticket-detail", kwargs={'pk': id}))
...
def add_comment(request, ticket_id):
    if request.method == 'POST':
        ...
        Comment.objects.create(ticket=ticket, user=user, text=comment)
        return HttpResponseRedirect(reverse("tickets:ticket-detail", kwargs={'pk': ticket_id}))


class SearchResultView(LoginRequiredMixin, generic.ListView):
    model = Ticket
    template_name = 'apps/tickets/search_results.html'
    login_url = '/accounts/signin/'
...
class StaffSearchResultView(LoginRequiredMixin, generic.ListView):
    model = Ticket
    template_name = 'apps/tickets/staff_search_results.html'
    login_url = '/accounts/signin/'
...
class UserPerformanceListView(LoginRequiredMixin, generic.ListView):
    model = Ticket
    template_name = 'apps/tickets/charts.html'
    login_url = '/accounts/signin/'
...
def user_performance_details(request, username):
    ...
    return render(request, 'apps/tickets/user_performance_detail.html', context)


class UserPerformanceDetailView(LoginRequiredMixin, generic.DetailView):
    model = Ticket
    template_name = 'apps/tickets/user_performance_detail.html'
